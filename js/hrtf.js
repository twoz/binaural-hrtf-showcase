...
function HRTFPanner(audioContext, sourceNode, hrtfContainer) {
	...
	*/
	...
	this.setHrtfContainer = function(newHrtfContainer) {
		hrtf = newHrtfContainer;
	}
	...
	*/
	this.update = function(azimuth, elevation) {
		targetConvolver.fillBuffer(hrtf.interpolateHRIR(azimuth, elevation));
		// start crossfading
